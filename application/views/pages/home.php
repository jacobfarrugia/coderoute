	...
	<div class="container">
		...
		<h1 class="intro">Learn to code in 12 weeks</h1>
		...
		<div class="col-lg-4 col-md-4 column">
			<ul class="skills">
				...
				<li class="skill">
					...
					<h6>35, 378</h6>
					<p>
						 The number of developer jobs advertised in the UK for the first 3 months of 2014
					</p>
				</li>
		...
		<div class="col-md-6 col-sm-6">
			...
			<div class="feature">
				<div class="feature-icon">
					<i ><img src="images/icon-zend.png"/></i>
				</div>
			...
			<div class="feature">
				<div class="feature-icon">
					<i ><img src="images/icon-mysql.png"/></i>
				</div>
				<h5>MySQL</h5>
				<p>
			...
			<div class="feature">
				<div class="feature-icon">
					<i ><img src="images/icon-git.png"/></i>
				</div>
				<h5>GIT</h5>
				<p>
