	...
	<div class="container">
		...
		<h3 class="intro">While working as a developer is primarily about, well, writing code, there are a host of skills that a modern full-stack web developer needs to have. These range from technical skills like software architecture, version control & test driven development to the often overlooked soft skills of communication and working in teams.</h3>
...
<div class="container">
		...
		<h2 class="dark-text">Why a boot camp?</h2>		
		<p>There are plenty of online, correspondence courses that claim they can teach you to code with a couple of hours of work in the evening. But if you want to really learn a new skill, a new skill like coding that is really hard to learn to do well, you need more than that.</p> 
...
<div class="color-overlay container">
	...
	<div class="row">
		...
		<div class="col-lg-3 col-sm-3 focus-box">
			<h5 class="green-border-bottom">CV clinics & Interview preparation</h5> 
			<p>
				We bring in professionals to help you perfect your current CV or create one from scratch. Your new CV will open doors and this is where our interview training and preparation, consisting of mock interviews and the technical tests used by a lot of tech employers, will take over. Putting you in the best possible position to secure that job.   
			</p>
		</div>
	
		<div class="col-lg-3 col-sm-3 focus-box">
			<h5 class="green-border-bottom">Networking with industry peers</h5>
			<p>
				 Being around girls and guys who are already involved in the tech scene is one of the main features of coming on a Coderoute course. We will make sure you do the rounds of industry events, presentations and meet-ups, so you can get to know as many potential employers and future colleagues as possible, at the same time as being exposed to the latest industry innovations and new thinking.    
			</p>
		</div>
		
		<div class="col-lg-3 col-sm-3 focus-box">
			<h5 class="green-border-bottom">Guest speakers from the tech world</h5>
			<p>
				We have a great line-up of guest speakers who are itching to come and meet our next cohort of Coderouters. These range from digital marketing and SEO specialists to software architects, Big Data gurus and Dev-Ops engineers . These sessions will really open your eyes to the many different facets of the tech industry and help your thinking when it comes to applying for jobs. 
			</p>
		</div>
		
		<div class="col-lg-3 col-sm-3 focus-box ">
			<h5 class="green-border-bottom">Work with specialist recruiters</h5>
			<p>
				We have a network of specialist tech recruiters, who we will introduce our students to near the end of the course. When you start looking for that first job, you will have all the support and advice needed, in terms of industry sectors to look at and companies to apply to. These are also guys who can sometimes put you in the frame for new opportunities before they have been advertised to the wider market 
			</p>
